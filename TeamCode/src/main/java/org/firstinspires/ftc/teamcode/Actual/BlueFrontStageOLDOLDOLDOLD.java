...
@Autonomous
@Disabled
public class BlueFrontStageOLDOLDOLDOLD extends LinearOpMode {
...
//                .splineTo(new Vector2d(10.97, 34.51), Math.toRadians(270))
                .lineTo(new Vector2d(-37.71, 33.78))
                .build();
        TrajectorySequence BlueCenterPropToBackDrop = drive.trajectorySequenceBuilder(BlueCenterProp.end())
                .waitSeconds(.5)
                .back(5)
                .lineTo(new Vector2d(-57.05, 30.07))
                .lineToLinearHeading(new Pose2d(-57.32, 3.41, Math.toRadians(180.00)))
                .lineTo(new Vector2d(25.94, 11.84))
                .lineTo(new Vector2d(50.20, 30))
                .build();
