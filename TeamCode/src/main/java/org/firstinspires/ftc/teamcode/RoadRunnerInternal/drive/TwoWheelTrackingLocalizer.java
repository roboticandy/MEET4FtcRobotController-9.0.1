...
import org.firstinspires.ftc.teamcode.RoadRunnerInternal.util.Encoder;
...
public class TwoWheelTrackingLocalizer extends TwoTrackingWheelLocalizer {
    ...
    public List<Double> getWheelVelocities() {
        ...
        return Arrays.asList(
                encoderTicksToInches(parallelEncoder.getRawVelocity()) * X_MULTIPLER,
                encoderTicksToInches(perpendicularEncoder.getRawVelocity()) * Y_MULTIPLER
        );
    }
}
