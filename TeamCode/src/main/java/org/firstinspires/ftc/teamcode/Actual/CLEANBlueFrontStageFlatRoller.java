...
@Autonomous
@Config
public class CLEANBlueFrontStageFlatRoller extends LinearOpMode {
...
//                }
    ...
    public void runOpMode() throws InterruptedException {
        ...
        BlueFrontSequence(drive,trajectorySequences,propLocation,pixelCounter);
        stop();
        if (isStopRequested()) return;
        stop();
    }

    public void BlueFrontSequence(Drive drive, TrajectorySequence[] trajectorySequences, PropPos prop, PixelCounter pixelCounter) {
        ...
        //175 for solo score, 225 for partner score
...
//                        drive.getAccelerationConstraint(DriveConstants.MAX_ACCEL))
        ...
        TrajectorySequence BCblueCenterProp = drive.trajectorySequenceBuilder(start)
                ...
                .lineToSplineHeading(new Pose2d(-54.5, 12, Math.toRadians(190.00)))
                //align with pixel stack
                .lineToSplineHeading(new Pose2d(-61, 6.5, Math.toRadians(180.00)))
                //slowly hit wall with dropdown
